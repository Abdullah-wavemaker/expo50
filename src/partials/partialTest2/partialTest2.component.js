...
import addPartialScript from './partialTest2.script';
import styles from './partialTest2.style';
import getVariables from './partialTest2.variables';
...
export default class partialTest2Partial extends BasePartial {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('partialTest2-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new(
        'partialTest2-styleOverrides',
        styleOverrides
      );
    }
  }
