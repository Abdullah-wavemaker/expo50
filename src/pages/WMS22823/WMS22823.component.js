...
import addPageScript from './WMS22823.script';
import styles from './WMS22823.style';
import getVariables from './WMS22823.variables';
  ...
  return (
    ...
    >
      <WmColumnChart
        ...
        xaxisdatakey="name"
        yaxisdatakey="ebita,loss,profit"
...
export default class WMS22823Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS22823-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS22823-styleOverrides', styleOverrides);
    }
  }
