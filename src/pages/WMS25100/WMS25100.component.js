...
import addPageScript from './WMS25100.script';
import styles from './WMS25100.style';
import getVariables from './WMS25100.variables';
  ...
  return (
    ...
    >
      <WmColumnChart
        ...
        name="chart1"
        dataset={fragment.Variables.chartDataset.dataSet}
        customcolors="#00BFFF, #556B2F, #2F4F4F, #C71585, #4169E1, #9370DB, #FF6347"
        hidegridxaxis="true"
        showxaxis={false}
        offsetxaxis={30}
        xaxisdatakey="name"
...
export default class WMS25100Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS25100-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS25100-styleOverrides', styleOverrides);
    }
  }
