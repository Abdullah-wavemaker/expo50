...
import WmDeviceSpecificPrefab from '../../prefabs/DeviceSpecific/src/pages/Main/Main.component';
...
import addPageScript from './WMS23765.script';
import styles from './WMS23765.style';
import getVariables from './WMS23765.variables';
...
const PC_Devicespecific1 = ({ fragment }) => {
  return (
    <WmDeviceSpecificPrefab
      prefabname="DeviceSpecific"
      name="DeviceSpecific1"
      listener={fragment}
...
const PC_Page_content1 = ({ fragment }) => {
  return (
    ...
    >
      <PC_Devicespecific1 fragment={fragment} />
    </WmPageContent>
  );
};
...
export default class WMS23765Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS23765-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS23765-styleOverrides', styleOverrides);
    }
  }
