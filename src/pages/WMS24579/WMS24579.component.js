...
import addPageScript from './WMS24579.script';
import styles from './WMS24579.style';
import getVariables from './WMS24579.variables';
    ...
    >
      ...
      >
        <WmLinearlayoutitem
          ...
          styles={{
            root: {
              backgroundImage: 'resources/images/imagelists/mrbean2.jpeg',
      ...
      <WmContainer
        ...
        styles={{
          root: {
            backgroundImage: 'resources/images/imagelists/mrbean3.jpeg',
...
export default class WMS24579Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS24579-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS24579-styleOverrides', styleOverrides);
    }
  }
