...
import addPageScript from './WMS25176.script';
import styles from './WMS25176.style';
import getVariables from './WMS25176.variables';
...
const PC_Page_content1 = ({ fragment }) => {
  return (
    ...
    >
      ...
      >
        <WmFormBody name="wm_form_body_b19d924g6j" listener={fragment}>
        ...
        <WmFormFooter name="wm_form_footer_2b2d5g9a3b" listener={fragment}>
          <WmFormAction
...
export default class WMS25176Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS25176-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS25176-styleOverrides', styleOverrides);
    }
  }
