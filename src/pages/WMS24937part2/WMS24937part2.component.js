...
import addPageScript from './WMS24937part2.script';
import styles from './WMS24937part2.style';
import getVariables from './WMS24937part2.variables';
  ...
  return (
    ...
    >
      ...
      <WmLineChart
        ...
        onBeforerender={(widget, chartInstance) => {
          fragment.chart2Beforerender(widget, chartInstance);
        }}
...
export default class WMS24937part2Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS24937part2-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new(
        'WMS24937part2-styleOverrides',
        styleOverrides
      );
    }
  }
