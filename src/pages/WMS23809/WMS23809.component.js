...
import addPageScript from './WMS23809.script';
import styles from './WMS23809.style';
import getVariables from './WMS23809.variables';
...
export default class WMS23809Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS23809-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS23809-styleOverrides', styleOverrides);
    }
  }
