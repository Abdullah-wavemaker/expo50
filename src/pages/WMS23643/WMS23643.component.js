...
import addPageScript from './WMS23643.script';
import styles from './WMS23643.style';
import getVariables from './WMS23643.variables';
...
const PC_Employee_firstname0 = ({ fragment }) => {
  return (
    <WmFormField
      readonly={false}
      name="Employee_firstname"
      ...
      show={true}
      widget="text"
      formRef="createEmployeeForm1_1"
      primaryKey="undefined"
      isRelated="undefined"
      onChange={($event, widget, newVal, oldVal) => {
        fragment.Widgets.createEmployeeForm1_1 &&
          fragment.Widgets.createEmployeeForm1_1.props.onChange &&
          fragment.Widgets.createEmployeeForm1_1.props.onChange(
            $event,
            widget,
            newVal,
...
const PC_Employee_lastname0 = ({ fragment }) => {
  return (
    <WmFormField
      readonly={false}
      name="Employee_lastname"
...
const PC_Page_content1 = ({ fragment }) => {
  return (
    ...
    >
      ...
      >
        <WmFormBody name="wm_form_body_5dh59811h9" listener={fragment}>
        ...
        <WmFormFooter name="wm_form_footer_3004ad2e08" listener={fragment}>
          <WmFormAction
            show={true}
          ...
          <WmFormAction
            ...
            title="Save"
            action="()=&gt; fragment.Widgets.createEmployeeForm1.submit();fragment.Actions.notificationAction1.invoke()"
            disabled={false}
            widget-type="button"
            formKey="createEmployeeForm1"
            ...
            formAction={$event => {
              ...
              fragment.Actions.notificationAction1.invoke();
            }}
          ></WmFormAction>
        </WmFormFooter>
      </WmForm>
      ...
      >
        <WmFormBody name="wm_form_body_7f70gb368e" listener={fragment}>
          <WmLayoutgrid columns="1" name="layoutgrid2" listener={fragment}>
            ...
            <WmGridrow name="gridrow8" listener={fragment}>
              <WmGridcolumn
                ...
                listener={fragment}
              >
                <PC_Employee_firstname0 fragment={fragment} />
              </WmGridcolumn>
            </WmGridrow>
            <WmGridrow name="gridrow9" listener={fragment}>
              <WmGridcolumn
                ...
                listener={fragment}
              >
                <PC_Employee_lastname0 fragment={fragment} />
              </WmGridcolumn>
            </WmGridrow>
          </WmLayoutgrid>
        </WmFormBody>
        <WmFormFooter name="wm_form_footer_25f80febh0" listener={fragment}>
          <WmFormAction
            iconclass="wi wi-refresh"
            formKey="createEmployeeForm1_1"
            name="createEmployeeForm1_1_reset_formAction"
            displayName="Reset"
            action="()=&gt; fragment.Widgets.createEmployeeForm1_1.formreset()"
            btnClass="btn-default"
            classname="form-reset btn-default"
            listener={fragment}
            formAction={$event => {
              fragment.Widgets.createEmployeeForm1_1.formreset();
            }}
          ></WmFormAction>
          <WmFormAction
            iconclass="wi wi-save"
            formKey="createEmployeeForm1_1"
            name="createEmployeeForm1_1_submit_formAction"
            displayName="Save"
            action="()=&gt; fragment.Widgets.createEmployeeForm1_1.submit()"
            btnClass="btn-primary"
            classname="form-save btn-success"
            listener={fragment}
            formAction={$event => {
              fragment.Widgets.createEmployeeForm1_1.submit();
            }}
          ></WmFormAction>
        </WmFormFooter>
      </WmForm>
...
export default class WMS23643Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS23643-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS23643-styleOverrides', styleOverrides);
    }
  }
