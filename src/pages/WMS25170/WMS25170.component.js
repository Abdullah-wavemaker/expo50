...
import addPageScript from './WMS25170.script';
import styles from './WMS25170.style';
import getVariables from './WMS25170.variables';
      ...
      renderFormFields={$formField => (
        <>
          ...
          <WmText
            ...
            onBlur={($event, widget) => {
              fragment.dateBlur($event, widget);
            }}
...
const PC_Page_content1 = ({ fragment }) => {
  return (
    ...
    >
      ...
      >
        <WmFormBody name="wm_form_body_af902a98if" listener={fragment}>
        ...
        <WmFormFooter name="wm_form_footer_acg0de1hgc" listener={fragment}>
          <WmFormAction
      ...
      <WmComposite name="composite1" listener={fragment}>
        ...
        <WmContainer name="container1" classname="col-xs-8" listener={fragment}>
          <WmText name="text1" required={true} listener={fragment}></WmText>
        </WmContainer>
      </WmComposite>
    </WmPageContent>
  );
...
export default class WMS25170Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS25170-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS25170-styleOverrides', styleOverrides);
    }
  }
