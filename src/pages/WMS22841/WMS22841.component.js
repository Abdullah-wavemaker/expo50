...
import addPageScript from './WMS22841.script';
import styles from './WMS22841.style';
import getVariables from './WMS22841.variables';
  ...
  return (
    ...
    >
      ...
      <WmButton
        ...
        name="button1"
        onTap={() => {
          fragment.Variables.getEmployee.invoke();
        }}
...
export default class WMS22841Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS22841-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS22841-styleOverrides', styleOverrides);
    }
  }
