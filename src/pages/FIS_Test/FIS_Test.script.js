...
export default function addPageScript(App, Page) {
  ...
  Page.onReady = function () {
     ...
     */
    // Page.Widgets.radioset1.datavalue = "january";
  };
  // Page.Widgets.wizardstep2.onPrev = false;
  ...
  Page.nestedListDataList2Tap = function (
    $event,
    widget,
    item,
    currentItemWidgets
  ...
  Page.container1Tap = function ($event, widget) {
    console.log('disturbed unwantedly');
  };
}
