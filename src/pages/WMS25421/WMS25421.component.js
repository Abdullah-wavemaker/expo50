...
import addPageScript from './WMS25421.script';
import styles from './WMS25421.style';
import getVariables from './WMS25421.variables';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <WmContainer
          name="container1"
          styles={{ root: { backgroundColor: '#ff0000', width: 50 }, text: {} }}
          classname="col-xs-8"
          listener={fragment}
        >
          <WmCheckboxset
...
export default class WMS25421Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS25421-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS25421-styleOverrides', styleOverrides);
    }
  }
