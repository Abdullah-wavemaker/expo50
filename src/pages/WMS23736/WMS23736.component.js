...
import addPageScript from './WMS23736.script';
import styles from './WMS23736.style';
import getVariables from './WMS23736.variables';
...
const PC_Page_content1 = ({ fragment }) => {
  return (
    ...
    >
      ...
      >
        <WmFormBody name="wm_form_body_76b680fi45" listener={fragment}>
        ...
        <WmFormFooter name="wm_form_footer_h9f437e2j6" listener={fragment}>
          <WmFormAction
...
export default class WMS23736Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS23736-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS23736-styleOverrides', styleOverrides);
    }
  }
