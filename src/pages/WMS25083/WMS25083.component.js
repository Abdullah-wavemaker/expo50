...
import addPageScript from './WMS25083.script';
import styles from './WMS25083.style';
import getVariables from './WMS25083.variables';
  ...
  return (
    ...
    >
      <WmButton
        ...
        onLongtap={($event, widget) => {
          fragment.button1Longtap($event, widget);
        }}
        onPressout={($event, widget) => {
          fragment.button1Pressout($event, widget);
        }}
      ...
      <WmLabel
        name="label1"
        styles={{
          root: { fontWeight: 'bold', textAlign: 'center' },
...
export default class WMS25083Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS25083-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS25083-styleOverrides', styleOverrides);
    }
  }
