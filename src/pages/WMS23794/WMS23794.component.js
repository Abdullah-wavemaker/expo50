...
import addPageScript from './WMS23794.script';
import styles from './WMS23794.style';
import getVariables from './WMS23794.variables';
...
export default class WMS23794Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS23794-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS23794-styleOverrides', styleOverrides);
    }
  }
