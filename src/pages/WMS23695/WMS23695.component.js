...
import addPageScript from './WMS23695.script';
import styles from './WMS23695.style';
import getVariables from './WMS23695.variables';
        ...
        <WmContainer name="container1" classname="col-xs-8" listener={fragment}>
          <WmSelect
            ...
            onChange={($event, widget, newVal, oldVal) => {
              fragment.select1Change($event, widget, newVal, oldVal);
            }}
            listener={fragment}
          ></WmSelect>
        </WmContainer>
...
export default class WMS23695Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS23695-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS23695-styleOverrides', styleOverrides);
    }
  }
