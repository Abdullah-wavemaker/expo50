...
import addPageScript from './WMS23269WMS23196.script';
import styles from './WMS23269WMS23196.style';
import getVariables from './WMS23269WMS23196.variables';
  ...
  return (
    ...
    >
      <WmMenu
        ...
        name="menu1"
        dataset={fragment.Variables.menuitems.dataSet}
      ...
      <WmMenu
        ...
        autoclose="outsideClick"
        name="menu4"
        dataset={fragment.Variables.staticVariable6.dataSet}
        listener={fragment}
        itemlabel="itemlabel"
      ></WmMenu>
      <WmMenu
        ...
        autoclose="outsideClick"
        name="menu5"
        dataset={fragment.Variables.testMenu.dataSet}
        listener={fragment}
        itemlabel="name"
      ></WmMenu>
...
export default class WMS23269WMS23196Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS23269WMS23196-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new(
        'WMS23269WMS23196-styleOverrides',
        styleOverrides
      );
    }
  }
