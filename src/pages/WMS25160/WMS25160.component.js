...
import addPageScript from './WMS25160.script';
import styles from './WMS25160.style';
import getVariables from './WMS25160.variables';
        ...
        <WmContainer name="container1" classname="col-xs-8" listener={fragment}>
          <WmNumber
            ...
            onChange={($event, widget, newVal, oldVal) => {
              fragment.number1Change($event, widget, newVal, oldVal);
            }}
            updateon="default"
            styles={{
      ...
      <WmComposite name="composite2" listener={fragment}>
        ...
        <WmContainer name="container2" classname="col-xs-8" listener={fragment}>
          <WmCurrency
            name="currency1"
            onChange={($event, widget, newVal, oldVal) => {
              fragment.currency1Change($event, widget, newVal, oldVal);
            }}
            updateon="default"
...
export default class WMS25160Page extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('WMS25160-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('WMS25160-styleOverrides', styleOverrides);
    }
  }
