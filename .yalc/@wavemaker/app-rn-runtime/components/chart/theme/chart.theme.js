...
class ThemeFactory {
  getColorsObj(themeName) {
    return themes[themeName].colors;
  }
  getTheme(name, styles, customColors) {
    ...
    const baseChartTheme = {
      ...
      boxplot: assign({
        style: {
          ...
          maxLabels: assign({}, baseLabelStyles, {
            padding: 3
          }),
          median: {
            padding,
          ...
          medianLabels: assign({}, baseLabelStyles, {
            padding: 3
          }),
          min: {
            padding,
          ...
          minLabels: assign({}, baseLabelStyles, {
            padding: 3
          }),
          q1: {
            padding,
          ...
          q1Labels: assign({}, baseLabelStyles, {
            padding: 3
          }),
          q3: {
            padding,
          ...
          q3Labels: assign({}, baseLabelStyles, {
            padding: 3
          })
        },
        boxWidth: 20
      ...
      legend: {
        ...
        style: {
          ...
          // ThemeVariables.INSTANCE.chartLegendBorder
          labels: baseLabelStyles,
          title: assign({}, baseLabelStyles, {
            padding: 5,
            fontSize: ThemeVariables.INSTANCE.heading4FontSize
          })
        }
      },
      line: assign({
