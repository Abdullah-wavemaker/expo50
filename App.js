...
class App extends BaseApp {
  ...
  bootstrap() {
    ...
    this.startUpVariables = ['appInfo','boolean','chartData','chartdata2','chips','cities','dateFormats','deviceInfo','menuitems','nestedListData','radiosetData','serviceVariable1','serviceVariable2','staticVariable1','staticVariable2','staticVariable3','staticVariable5','staticVariable6','supportedLocale','testMenu','wizard','WMS22575','WMS23639',];
    this.startUpActions = [];
    this.autoUpdateVariables = ['serviceVariable1','serviceVariable2','testVariable','WMS23639',];
